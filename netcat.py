...
def usage():
    print("BHP Net Tool")
    print()
    print("Usage: bhpnet.py -t target_host -p port -b bufsiz")
    ...
    print()
    print("Examples: ")
    print("python3 bhpnet.py -t 192.168.0.1 -p 5555 -l -c -b 1024")
    print("python3 bhpnet.py -t 192.168.0.1 -p 5555 -l -u=c:\\target.exe -b 4096")
    print("python3 bhpnet.py -t 192.168.0.1 -p 5555 -l -e=\"cat /etc/passwd\" -b 1024")
    print("echo 'abcdefghi' | ./bhpnet.py -t 192.168.11.12 -p 135 -b 4096")
    sys.exit(0)
